            ...
            <div class="collapse navbar-toggleable-xs" id="exCollapsingNavbar2">
                ...
                <ul class="nav navbar-nav right">
                    ...
                    <li class="nav-item" id="second">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu u01">
                                <li><a href="view-all.php" style="color: #761fa3 !important; font-weight: 700;">View All Assets</a></li>
                    ...
                    <li class="nav-item" id="fifth">
                        <a class="nav-link active5" style="height: 50px;" href="k-keyresource.php"></a>
                    </li>
                </ul>
                <div class="clear"></div>
            </div>
...
<div class="container">
  ...
  <!-- Begin DB Query -->
  <?php include (APP_QUERY_PATH . '/k-read-keyresource1.php');?>
</div>
